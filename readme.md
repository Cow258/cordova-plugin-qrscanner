...
```js
// For iOS
QRScanner.vibrate("light");
QRScanner.vibrate("medium");
QRScanner.vibrate("heavy");
QRScanner.vibrate("soft");
QRScanner.vibrate("rigid");
QRScanner.vibrate("success");
QRScanner.vibrate("warning");
QRScanner.vibrate("error");
QRScanner.vibrate(0); // Won't do anything
QRScanner.vibrate(1); // Vibrate .sort
QRScanner.vibrate(0 - 99); // Vibrate .light
QRScanner.vibrate(100 - 299); // Vibrate .medium
QRScanner.vibrate(300); // Vibrate .heavy

// For Android
QRScanner.vibrate(0); // Cancel vibrate
QRScanner.vibrate(100); // Vibrate 100 milliseconds
QRScanner.vibrate([100, 100]); // Vibrate with a pattern
```
